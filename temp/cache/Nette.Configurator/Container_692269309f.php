<?php
// source: D:\Programy\EasyPHP-DevServer-14.1VC11\data\localweb\jazykovka\app/config/config.neon 
// source: D:\Programy\EasyPHP-DevServer-14.1VC11\data\localweb\jazykovka\app/config/config.local.neon 

class Container_692269309f extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'App\Model\Repository' => array(
				1 => array('26_App_Model_PostRepository'),
			),
			'App\Model\PostRepository' => array(
				1 => array('26_App_Model_PostRepository'),
			),
			...
			'App\Presenters\PostsPresenter' => array(array('application.3')),
		...
		'services' => array(
			...
			'26_App_Model_PostRepository' => 'App\Model\PostRepository',
			...
			'application.3' => 'App\Presenters\PostsPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'D:\Programy\EasyPHP-DevServer-14.1VC11\data\localweb\jazykovka\app',
			'wwwDir' => 'D:\Programy\EasyPHP-DevServer-14.1VC11\data\localweb\jazykovka\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'D:\Programy\EasyPHP-DevServer-14.1VC11\data\localweb\jazykovka\app/../temp',
		));
	}
	...
	/**
	 * @return App\Model\PostRepository
	 */
	public function createService__26_App_Model_PostRepository()
	{
		$service = new App\Model\PostRepository($this->getService('database.default.context'));
		return $service;
	}
	...
	public function createServiceApplication__1()
	{
		...
		$service->postRepository = $this->getService('26_App_Model_PostRepository');
	...
	/**
	 * @return App\Presenters\PostsPresenter
	 */
	public function createServiceApplication__3()
	{
		$service = new App\Presenters\PostsPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->postRepository = $this->getService('26_App_Model_PostRepository');
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\Programy\EasyPHP-DevServer-14.1VC11\data\localweb\jazykovka\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('D:\Programy\EasyPHP-DevServer-14.1VC11\data\localweb\jazykovka\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\Programy\EasyPHP-DevServer-14.1VC11\data\localweb\jazykovka\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=jazykovka', 'root', '', array('lazy' => TRUE));
	...
	{
		return new Container_692269309f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('D:\Programy\EasyPHP-DevServer-14.1VC11\data\localweb\jazykovka\app/../temp/cache/latte');
...
final class Container_692269309f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{

	private $container;


	public function __construct(Container_692269309f $container)
	{
