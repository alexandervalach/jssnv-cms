...
CREATE TABLE `application_forms` (
  ...
  `title_bn` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `title_an` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `id_number` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `employment` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `prev_course` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `consent_personal_data` tinyint(2) DEFAULT '1',
  `consent_name` tinyint(2) DEFAULT '1',
  `consent_photo` tinyint(2) DEFAULT '1',
  `note` tinytext COLLATE utf8_slovak_ci,
  `status` enum('pending','cancelled','finished','archived') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `is_present` tinyint(4) NOT NULL DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `branch_class_id` (`branch_class_id`),
  CONSTRAINT `application_forms_ibfk_1` FOREIGN KEY (`branch_class_id`) REFERENCES `branches_classes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_slovak_ci;
...
CREATE TABLE `branches` (
  ...
  `thumbnail` varchar(255) COLLATE utf8_slovak_ci DEFAULT NULL,
  `hq` tinyint(4) NOT NULL DEFAULT '0',
  `is_present` tinyint(4) NOT NULL DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `branches_classes`;
CREATE TABLE `branches_classes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `branches_classes_ibfk_1` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`),
  CONSTRAINT `branches_classes_ibfk_2` FOREIGN KEY (`class_id`) REFERENCES `classes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_slovak_ci;
...
CREATE TABLE `classes` (
  ...
  `is_present` tinyint(2) DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `course_id` (`course_id`),
  KEY `course_level_id` (`course_level_id`),
  CONSTRAINT `classes_ibfk_1` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`),
  CONSTRAINT `classes_ibfk_2` FOREIGN KEY (`course_level_id`) REFERENCES `course_levels` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_slovak_ci;
...
CREATE TABLE `courses` (
  ...
  `label` varchar(255) COLLATE utf8_slovak_ci NOT NULL,
  `is_present` tinyint(4) NOT NULL DEFAULT '1',
  `acronym` varchar(10) COLLATE utf8_slovak_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_slovak_ci;
...
CREATE TABLE `slides` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_slovak_ci NOT NULL,
  `message` text COLLATE utf8_slovak_ci,
